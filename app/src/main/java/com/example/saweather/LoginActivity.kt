...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setButtonsEnabled(enabled: Boolean) {
        ...
        binding.btnLogin.text = if (enabled) "Sign In" else "Signing in..."
        binding.btnRegister.text = if (enabled) "Create New Account" else "Creating Account..."
    }
